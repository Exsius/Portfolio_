...
const Paper = (props: IPaperProps) => {
    ...
    const [paperStyle, setPaperStyle] = useState({ backgroundColor: theme.pallete.base, border: "solid", borderRadius: theme.style.Paper.borderRadius, borderWidth: '1px', borderColor: theme.pallete.border, padding: "16px 8px" })
